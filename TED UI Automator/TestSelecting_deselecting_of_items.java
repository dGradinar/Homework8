...
public class TestSelecting_deselecting_of_items extends ActivityInstrumentationTestCase2<Activity> {
	...
	public TestSelecting_deselecting_of_items() {
	...
	public void testRecorded() throws Exception {
		try {
			...
			solo.fail("kdk.android.simplydo.test.TestSelecting_deselecting_of_items.testRecorded_scr_fail", e);
			throw e;
		} catch (Exception e) {
			solo.fail("kdk.android.simplydo.test.TestSelecting_deselecting_of_items.testRecorded_scr_fail", e);
			throw e;
