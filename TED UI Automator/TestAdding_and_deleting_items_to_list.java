...
public class TestAdding_and_deleting_items_to_list extends ActivityInstrumentationTestCase2<Activity> {
	...
	public TestAdding_and_deleting_items_to_list() {
	...
	public void testRecorded() throws Exception {
		try {
			...
			solo.fail("kdk.android.simplydo.test.TestAdding_and_deleting_items_to_list.testRecorded_scr_fail", e);
			throw e;
		} catch (Exception e) {
			solo.fail("kdk.android.simplydo.test.TestAdding_and_deleting_items_to_list.testRecorded_scr_fail", e);
			throw e;
